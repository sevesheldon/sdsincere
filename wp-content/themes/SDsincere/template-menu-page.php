			...
			<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
				...
				<div class="page-content container">
					...
					<div id="indica-rows" class="row">
						...
						<div class="cat-name" id="cat-name-indica">
					...
					<div id="sativa-rows" class="row">

						<div class="cat-name" id="cat-name-sativa">

							<h1>Sativa</h1>

						</div>		

					<?php if( have_rows('sativa') ): ?>
							<?php while( have_rows('sativa') ): the_row(); 
									$image_object = get_sub_field('image-sativa');
									$image_size = 'thumbnail';
									$image_url = $image_object['sizes'][$image_size];
									?>

									<div class="content col-sm-12" id="sativa-content">
											...
											<div class="row1 col-2 col-sm-7">
												...
												<div class="row">
													...
													<div class="col-sm-9">	
					    		    					...
					    		    					<h2><?php the_sub_field('name-sativa'); ?></h2>

					    		    					<p>Sativa | <?php the_sub_field('description-sativa'); ?></p>
					    		    				...
					    		    				<div class="col-sm-1">	
					    		    					...
					    		    					<p class="values"><?php the_sub_field('thc-sativa'); ?>%</p>
					    		    				...
					    		    				<div class="col-sm-1">
					    		    					...
					    		    					<p class="values"><?php the_sub_field('cbd-sativa'); ?>%</p>
					    		    				...
					    		    				<div class="col-sm-1">
					    		    					...
					    		    					<p class="values"><?php the_sub_field('cbn-sativa'); ?>%</p>
											...
											<div class="row1 col-3 col-sm-3">
												...
												<div class="prices row">
													...
													<div class="col-sm-3">	
							    		    			...
							    		    			<div class="weight" id="1/8-sativa"><p>1/8</p><h4 class="values price">$<?php the_sub_field('1/8-sativa'); ?></h4></div>

							    		    		</div>
							    		    		
							    		    		<div class="col-sm-3">		

							    		    			<div class="weight" id="1/4-sativa"><p>1/4</p><h4 class="values price">$<?php the_sub_field('1/4-sativa'); ?></h4></div>

							    		    		</div>
							    		    		
							    		    		<div class="col-sm-3">		

							    		    			<div class="weight" id="1/2-sativa"><p>1/2</p><h4 class="values price">$<?php the_sub_field('1/2-sativa'); ?></h4></div>

							    		    		</div>
							    		    		
							    		    		<div class="col-sm-3">		

							    		    			<div class="weight" id="oz-sativa"><p>Oz.</p><h4 class="values price">$<?php the_sub_field('oz-sativa'); ?></h4></div>
